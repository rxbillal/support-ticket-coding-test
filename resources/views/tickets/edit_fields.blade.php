<div class="row">
    ...
    @else
        ...
        <div class="form-group col-xl-6 col-md-6 col-sm-12">
            ...
            {{ Form::select('assignTo[]', $data['users'] ,null, ['id'=>'assignedTo','class' => 'form-control','required','multiple' => 'multiple']) }}
        </div>
        <div class="form-group col-xl-6 col-md-6 col-sm-12">
            {{ Form::label('customer', __('messages.customer.customer').':') }}<span class="text-danger">*</span>
            <div class="input-group">
                {{ Form::select('customer', $data['customers'] ,$ticket->created_by, ['id'=>'customer','class' => 'form-control', 'required', 'placeholder' => __('messages.user.select_customer')]) }}
                <div class="input-group-append plus-icon-height">
                    <div class="input-group-text">
