...
$(function () {
                    ...
                    if (active == true) {
                        ...
                        me.parent().
                            ...
                            slideDown(500, function () {
                                if (typeof currentUrlName !== 'undefined' ||
                                    currentUrlName !=
                                    null) {
                                    me.parent().
                                        find('> .dropdown-menu').
                                        ...
                                        each(function () {
                                            ...
                                            let drpMainMenuUrl = currentUrlName.substr(
                                                0,
                                                drpHref.length);
    ...
    $(document).on('click', '.nav-collapse-toggle', function () {
        ...
        if (!mini) {
            ...
            $('.main-sidebar .sidebar-menu > li').each(function () {
                ...
                if (me.find('> .dropdown-menu').length) {
                    ...
                    me.find('> .dropdown-menu').
                        prepend('<li class="dropdown-title pt-3">' +
                            me.find('> a').text() + '</li>');
                } else {
    ...
    var toggleLayout = function () {
        var w = $(window),
            ...
            layout_classes = (layout_class.trim().length > 0
                ? layout_class.split(' ')
                : '');
        ...
        if (w.outerWidth() <= 1112) {
            ...
            let nav_second_classes = $('.main-sidebar').
            ...
            if (now_layout_class == 'layout-3' &&
                ...
                main_sidebar.find('.sidebar-wrapper').
                    addClass('container').
                    removeClass('sidebar-wrapper');
                main_sidebar.find('.sidebar-menu').
                    addClass('navbar-nav').
