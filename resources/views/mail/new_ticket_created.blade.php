                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                            ...
                                                            <tr>
                                                                <td align="left" class="esd-block-text">
                                                                    <p style="color: #666666;">Hello!&nbsp;{{ $user_name }},<br><br>This message is to inform that you&nbsp;created a ticket<strong><span>&nbsp;</span></strong>and the details are as follows:<br><br>Ticket Title:&nbsp;<strong>{{ $title }}</strong><br>Ticket ID:&nbsp;<strong>{{ $ticket_id }}</strong><br><br>For more information visit the ticket detail screen.<br><br>Thank you.</p>
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
