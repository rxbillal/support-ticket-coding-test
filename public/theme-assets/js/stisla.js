...
(function ($, window, i) {
        ...
        this.each(function () {
            ...
            var modal_template = '   <div class="modal' +
                ...
                ((options.header == true) ?
                    ...
                    '           <h5 class="modal-title">' + options.title +
                    '</h5>  ' +
            ...
            if (options.bodyClass) $(modal_template).
                find('.modal-body').
                addClass(options.bodyClass);

            // add footer body class
            if (options.footerClass) $(modal_template).
                find('.modal-footer').
            ...
            if (modal_form.length) {
                ...
                if (!modal_form.find('button').length) $(modal_form).
                    append('<button class="d-none" id="' + id +
                        '-submit"></button>');
                ...
                modal_form.submit(function (e) {
                    ...
                    options.onFormSubmit.call(this, modal_template, e,
                        form_object);
                });
            }
    ...
    $.cardProgress = function (card, options) {
        ...
        if (options.dismiss == true) {
            var btn_dismiss = '<a class="btn btn-danger card-progress-dismiss">' +
                options.dismissText + '</a>';
    ...
    $.chatCtrl = function (element, chat) {
        ...
        var target = $(element),
            element = '<div class="chat-item ' + chat.position +
                '" style="display:none">' +
