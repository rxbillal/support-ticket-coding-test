            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="form-group col-12">
                        {{ Form::label('default_language',__('messages.user_language.language') .':') }}<span
                                class="text-danger">*</span>
                        {{ Form::select('default_language',LANGUAGES,getLoggedInUser()->default_language,['id' => 'defaultLanguage', 'class' => 'form-control','required']) }}
                    </div>
                </div>
