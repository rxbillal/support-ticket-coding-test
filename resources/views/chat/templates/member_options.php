        ...
        <div class="btn-group">
            ...
            <div class="dropdown-menu member-options-{{:member_id}}">
                <a class="dropdown-item remove-member-from-group" href="#" data-member-id="{{:member_id}}"
                   data-group-id="{{:group_id}}" id="removeMember-{{:member_id}}"><?php echo __('messages.chats.remove_member') ?>></a>
                <a class="dropdown-item make-member-to-group-admin" href="#" data-member-id="{{:member_id}}"
                   data-group-id="{{:group_id}}" id="makeAdmin-{{:member_id}}"><?php echo __('messages.chats.make_admin') ?></a>
            </div>
        </div>
    </div>
</div>
