<form class="form-inline mr-auto m-block-end-unset" action="#">
        ...
        <li class="dropdown">
            <a href="#" data-toggle="dropdown"
               class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                ...
                $authUser = Auth::user()->load('media');
                @endphp
                <img src="{{ $authUser->photo_url }}"
                     class="rounded-circle mr-1 thumbnail-rounded user-thumbnail " alt="">
                <div class="d-sm-none d-lg-inline-block">
                    {{ __('messages.common.hi') }}, {{ $authUser->name}}</div>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
                <a class="dropdown-item has-icon editProfileModal" href="#" data-id="{{ $authUser->id }}">
