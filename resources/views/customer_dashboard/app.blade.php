...
<div id="app" class="admin-app">
    ...
    <div class="main-wrapper main-wrapper-1">
        ...
        <nav class="navbar customer-dashboard-navbar navbar-expand-lg main-navbar">
            @include('customer_dashboard.header')
        </nav>
        <div class="main-sidebar">
            @include('customer_dashboard.sidebar')
...
<script>
    ...
    let profileUrl = "{{ url('customer/profile') }}"
    let profileUpdateUrl = "{{ url('customer/profile-update') }}"
    let changePasswordUrl = "{{ url('customer/change-password') }}"
    ...
    let isCustomer = "{{ getLoggedInUserRoleId() == getCustomerRoleId() }}"
